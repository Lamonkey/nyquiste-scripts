...
from context import (
    HOST, PORT, USERNAME, PASSWORD, REMOTE_DIR, LOCAL_DIR
)
...
def run_test():
    ...
    print("Running comprehensive speed comparison tests")
    print(f"Local directory: {LOCAL_DIR}")
    print(f"Remote directory: {REMOTE_DIR}")
    print(f"Server: {HOST}:{PORT}")
    
    # Run the comprehensive speed comparison tests (now synchronous)
    run_comprehensive_tests(
        HOST, PORT, USERNAME, PASSWORD, LOCAL_DIR, REMOTE_DIR
    )
